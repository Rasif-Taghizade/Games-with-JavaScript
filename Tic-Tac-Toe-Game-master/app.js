// blokları, Oyunçunu və Errormesajını seçirik
...
// Blokların içinə X və ya O qoyuruq
function chooseArea(block){
    if(block.textContent === ""){
        ...
        errorText.textContent = "Heyyy, it's not empty!";
...
// Əgər blok X-dirsə onu O-ya çevirsin. Və ya əksinə
function turnPlayer(){
    if(player === "X"){
        player = "O";
        playerText.textContent = `${player}'s Turn !`
